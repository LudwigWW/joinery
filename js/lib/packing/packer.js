...
// import PlaceWorker from './workers/place.worker.js'
// import NfpWorker from './workers/nfp.worker.js'

// let placeWorker = new PlaceWorker()
// let nfpWorker = new NfpWorker()

let placeWorker = new Worker('js/lib/packing/workers/place.worker.js', { type: 'module' });
let nfpWorker = new Worker('js/lib/packing/workers/nfp.worker.js', { type: 'module' });
...
export default class Packer {
  ...
  stop() {
    ...
    nfpWorker = new Worker('js/lib/packing/workers/nfp.worker.js', { type: 'module' });
    placeWorker = new Worker('js/lib/packing/workers/place.worker.js', { type: 'module' });
  }
